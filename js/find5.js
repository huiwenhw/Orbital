...
var find_window_border = "white"; // the border color of pop-up window
...
var find_window_height = 130; // height of window
...
/*	for (fobj; !fobj.nodeName.match(/body|textarea|input/i); fobj=fobj.parentNode)
	{
		//document.getElementById('find_msg').innerHTML += fobj.nodeName;
		if (fobj)
...
function MouseMove(event)
{
	if (drag.isdrag)
	{
		...
		drag.drag_obj.style.left = drag.drag_obj_x + drag.tempx - drag.mousex;
		drag.drag_obj.style.top  = drag.drag_obj_y + drag.tempy - drag.mousey;
		return false;
	}
